...
def not_found(error):
    return render_template('index.html', error='Page not found', **model_metrics), 404

@app.errorhandler(500)
def internal_error(error):
    return render_template('index.html', error='Internal server error', **model_metrics), 500
